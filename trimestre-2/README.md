...
│   ├── santiagoconcodo.py       # Primeros ejercicios en Python
│   ├── ejercicios-pseudocodo1.md # Ejercicios de pseudocódigo
│   ├── index.html               # Página de inicio del módulo
│   └── mockups-operpan-v0.png   # Mockups del proyecto OperPan
├── Reglas de Consistencia.md    # Principios de consistencia en bases de datos
├── Verificación Modelos.md      # Verificación y validación de modelos de software
...
Actualmente, estoy organizando y desarrollando el contenido técnico del segundo trimestre. Los siguientes documentos están disponibles o en proceso:

- **[Reglas de Consistencia.md](./Reglas%20de%20Consistencia.md)** – Principios y buenas prácticas para mantener la consistencia en bases de datos relacionales: integridad referencial, restricciones, transacciones ACID, y normas de normalización.

- **[Verificación Modelos.md](./Verificaci%C3%B3n%20Modelos.md)** – Métodos y técnicas para verificar y validar modelos de software, incluyendo revisiones formales, inspecciones de código, pruebas de modelos y caminos de prueba.
...
Estoy en proceso de organizar y expandir el contenido técnico del trimestre. Próximamente se agregarán:

- Más ejercicios prácticos en Python.
- Documentación detallada sobre reglas de consistencia y verificación de modelos.
- Ejemplos aplicados al proyecto formativo (OperPan).
- Material sobre buenas prácticas de desarrollo y pruebas de software.
